          ...
          <div className="flex-1 flex items-center justify-center p-6">
            <div className="w-full max-w-lg">
              <div className="text-center mb-6">
                <div className="w-14 h-14 rounded-2xl flex items-center justify-center mx-auto mb-3" style={{ background: "#fff1f2" }}>
                  <Lock className="w-7 h-7 text-red-600" />
                </div>
                <h1 className="text-2xl font-bold text-[var(--text)] mb-1">Protect PDF</h1>
